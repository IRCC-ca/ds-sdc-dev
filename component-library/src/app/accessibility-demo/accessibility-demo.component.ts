...
export const CITIES_OF_BIRTH_LOVS_USA: ICityOfBirth[] = [
  { lov: 'ACC_DEMO.PERSONAL_INFO.CITY_OF_BIRTH.OPTIONS.TAMPA', val: 'Tampa Bay' },
  { lov: 'ACC_DEMO.PERSONAL_INFO.CITY_OF_BIRTH.OPTIONS.WASHINGTON', val: 'Washington' },
  { lov: 'ACC_DEMO.PERSONAL_INFO.CITY_OF_BIRTH.OPTIONS.NEW_YORK', val: 'New York' },
  { lov: 'ACC_DEMO.PERSONAL_INFO.CITY_OF_BIRTH.OPTIONS.OAKLAND', val: 'Oakland' }
];
