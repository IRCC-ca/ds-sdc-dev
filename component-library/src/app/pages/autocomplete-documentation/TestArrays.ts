export default class TestArrays {
  static quotes: string[] = [
    ...
    'Life in the wide world goes on much as it has this past Age, full of its own comings and goings, scarcely aware of the existence of Hobbits, for which I am very thankful.',
