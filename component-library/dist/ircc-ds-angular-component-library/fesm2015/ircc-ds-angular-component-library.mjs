...
class JLDropdownComponent {
    ...
    handleKeyDown(event) {
        var _a;
        event.stopPropagation();
        if (this.hideDropdown === false || (((_a = this.config) === null || _a === void 0 ? void 0 : _a.options) || []).length > 0) {
            this.isComponentClicked = false;
            this.isFocusInsideComponent = false;
            this.hideDropdown = true;
        }
    ...
    selectIndex(index) {
        ...
        if (this.config) {
            ...
            emit ? this.onChange(((_a = this.config) === null || _a === void 0 ? void 0 : _a.options[(((_b = this.config) === null || _b === void 0 ? void 0 : _b.selectedIndex) || 0)].value) || '') : '';
...
class RadioInputComponent {
    ...
    ngOnInit() {
        var _a;
        if ((_a = this.config) === null || _a === void 0 ? void 0 : _a.small)
...
class DatePickerComponent {
    ...
    ngOnInit() {
        ...
        (_a = this.dateForm.get((this.id + '_monthControl'))) === null || _a === void 0 ? void 0 : _a.valueChanges.subscribe(month => {
            var _a, _b;
            //add if statement here - the value of year can be empty, since it may not have been selected yet.
            const numDays = this.updateDaysArray(month, (_a = this.dateForm.get((this.id + '_yearControl'))) === null || _a === void 0 ? void 0 : _a.value);
            console.log(month, numDays);
            console.log((_b = this.dateForm.get((this.id + '_yearControl'))) === null || _b === void 0 ? void 0 : _b.value);
        });
        (_b = this.dateForm.get((this.id + '_yearControl'))) === null || _b === void 0 ? void 0 : _b.valueChanges.subscribe(year => {
            var _a;
            const numDays = this.updateDaysArray((_a = this.dateForm.get((this.id + '_monthControl'))) === null || _a === void 0 ? void 0 : _a.value, year);
        });
    ...
    updateDaysArray(month, year) {
        ...
        (_a = this.dateForm.get((this.id + '_dayControl'))) === null || _a === void 0 ? void 0 : _a.setValue('');
    }
    /**
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.1.3", ngImport: i0, type: LanguageSwitchComponent, decorators: [{
        ...
        return [{ type: undefined, decorators: [{
                        type: Inject,
                        args: [PLATFORM_ID]
                    }] }, { type: LanguageSwitchButtonService }];
    }, propDecorators: { id: [{
                type: Input
            }], handleResize: [{
                type: HostListener,
